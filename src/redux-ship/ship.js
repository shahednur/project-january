...
export type Command<Effect, Commit, State> =
  ...
  | { type: 'GetState', selector(state: State): any };

export type Yield<Effect, Commit, State> =
  | { type: 'Command', command: Command<Effect, Commit, State> }
  | { type: 'All', ships: Generator<Yield<Effect, Commit, State>, any, any>[] };
...
) => Ship<Effect, Commit, State, [A1, A2, A3, A4]> = allAny;
...
) => Ship<Effect, Commit, State, [A1, A2, A3, A4, A5]> = allAny;
...
) => Ship<Effect, Commit, State, [A1, A2, A3, A4, A5, A6]> = allAny;
...
) => Ship<Effect, Commit, State, [A1, A2, A3, A4, A5, A6, A7]> = allAny;
